...
function addTodo() {
  ...
  todos.value.push({date: date.value, id: lastId + 1, title: title.value, done: false});
...
input[type=text] { padding: 0.3em; margin-right: 0.3em; width: 270px; }
input[type=date] { padding: 0.3em; margin-right: 0.3em; }
button { padding: 0.3em 1em; margin-right: 5px; background-color: #0af; color: white;}
